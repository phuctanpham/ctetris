...
[x] Task 1.2: viết v1 gameCore/app.cpp - tạo layout.h và build .exe đảm bảo màn hình 9:16 trước khi viết code tiếp
    - Comment codeblock này trong gamecorre/app.cpp là: gamecore-tao-giao-dien-169-00
...
[x] Task 1.3: viết v1 gameCore/app.cpp - tạo 1 trong 6 khối (L,I,T,Z letf, Z right, O) đơn sắc
    - Comment codeblock này trong gamecorre/app.cpp là: gamecore-tao-cac-khoi-xep-hinh-LITZO-01
...
[x] Task 1.4: viết v1 gameCore/app.cpp - đổ màu ngẫu nhiên (Blue, Red, Green,Yellow, Orange, Purple)
    - Comment codeblock này trong gamecorre/app.cpp là:  gamecore-do-mau-02
...
[x] Task 1.5: viết v1 gameCore/app.cpp - cho khối rơi tự do ở 1 vị trí bất kỳ (on top)
    - Comment codeblock này trong gamecorre/app.cpp là: gamecore-xu-ly-roi-03
...
[x] Task 1.6: viết v1 gameCore/app.cpp - điều khiển khối bằng các mũi tên và WASD
    - Comment codeblock này trong gamecorre/app.cpp là:  gamecore-xu-ly-phim-04
...
[x] Task 1.7: viết v1 gameCore/app.cpp - hiệu ứng chạm và dừng rơi khối
    - Comment codeblock này trong gamecorre/app.cpp là:  gamecore-xu-ly-cham-05
...
[ ] Task 2.1: viết v2 gameCore/app.cpp - tốc độ rơi nhanh dần theo điểm số.
    - Comment codeblock này trong gamecorre/app.cpp là:  gamecore-tang-do-kho-09
...
[ ] Task 2.2: viết v2 gameCore/app.cpp - nhạc nền trong suốt tiến trình
    - Comment codeblock này trong gamecorre/app.cpp là:  gamecore-chen-nhac-nen-09
    - Đặt thứ tự codeblock này từ trên xuống ở vị trí sau 08 và trên 10
[ ] Task 3.1: viết v3 gameCore/app.cpp - dự báo 3 khối
    - Comment codeblock này trong gamecorre/app.cpp là: gamecore-du-bao-ba-khoi-xep-hinh-lien-tiep-08
    - Đặt thứ tự codeblock này từ trên xuống ở vị trí sau 09 và trên 11
[ ] Task 3.2: viết v3 gameCore/app.cpp - các phím (pause/play)
    - Comment codeblock này trong gamecorre/app.cpp là:  gamecore-pause-vs-play-11
...
[ ] Task 3.3: viết v3 gameCorre/app.cpp - nút quit
    - Comment codeblock này trong gamecorre/app.cpp là:  gamecore-quit-button-12
...
[ ] Task 3.4: viết v3 gameCore/app.cpp - cho phép nhập tên khi game over
    - Comment codeblock này trong gamecorre/app.cpp là:  gamecore-game-over-screen-13
...
[ ] Task 3.5: viết v3 gameCore/app.cpp - gọi API và gửi tên và điểm lên Mongo atlas
    - Comment codeblock này trong gamecorre/app.cpp là: gamecore-tich-hop-backend-14
