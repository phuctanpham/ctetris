...
## Explaination
1) Đồ thị thay thế github network. 
![Cập nhật và tinh gọn để báo cáo tuần 3](imgs/readme01.png)  
2) Github network không hỗ trợ tài khoản miễn phí tốt. 
![Bằng chứng github SAI dù github rất LỚN](imgs/readme02.png)  
3) Các bằng chứng làm việc nhóm như gợi ý từng tuần.  
![Nỗ lực cố gắng của nhóm để đạt được kỳ vọng như gợi ý dự án trong tuần 2 và tuần 3](imgs/readme03.png)  
