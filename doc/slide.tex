...
\newcommand{\TitleLine}[1]{%
  % Yellow (cyel) for the left outer border
...
% Debug marker: a small red rectangle to verify rendering
\begin{tikzpicture}[remember picture]
  \fill[red] (current page.north west) ++(10mm,-10mm) rectangle ++(20mm,-15mm);
\end{tikzpicture}
...
\begin{tikzpicture}[remember picture]
  ...
  \begin{scope}[shift={(NW)}]
    ...
    \node[anchor=north west, font=\fontsize{16}{24}\selectfont, text width=160mm] at (17mm, -100mm) {
      ...
      \textbf{GVHD: Thạc sỹ Nguyễn Văn Toàn}
    };
...
\begin{tikzpicture}[remember picture]
  ...
  \begin{scope}[shift={(NW)}]
    ...
    {
      Slide 1: Phân hệ chính - Tổng quát & Slide 2: Phân hệ chính - V1 vs V2 & Slide 3: Phân hệ chính - Thống kê \\
      Slide 4: Phân hệ cấu hình - Tổng quát & Slide 5: Phân hệ cấu hình - V1 vs V2 & Slide 6: Phân hệ cấu hình - Thống kê \\
      Slide 7: Phân hệ tuyến truyện - Tổng quát & Slide 8: Phân hệ tuyến truyện - V1 vs V2 & Slide 9: Phân hệ tuyến truyện - Thống kê \\
      Slide 10: Sơ đồ gameLoop & Slide 11: Chiến lược công nghệ & Slide 12: Sơ đồ lớp và CSDL \\
      Slide 13: Nguồn gốc xung đột chính & Slide 14: Giải quyết xung đột & Slide 15: Bài học lập trình nhóm \\
    };
  \end{scope}
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture]
  ...
  \begin{scope}[shift={(NW)}]
    ...
    % CỘT 1: 3 hộp tính năng (Đã dời lên)
    ...
    % CỘT 2: Sơ đồ Use Case (Đã dời lên)
    ...
    % Đáy trang: Đặc điểm cốt lõi nằm vắt ngang 2 cột
...
\begin{tikzpicture}[remember picture]
  ...
  \begin{scope}[shift={(NW)}]
    ...
    % Red dashed line
    \draw[red, dashed, line width=2.5pt] (115mm, -35mm) -- (115mm, -170mm);

    \node[anchor=north west, label={[sap]below:V2 - Normal}] at (118mm, -35mm) {
      \includegraphics[width=95mm, height=135mm, keepaspectratio]{10-gameCoreGuide-screenshot-v2.png}
    };
    \node[anchor=north west, label={[sap]below:V2 - Power Off}] at (219mm, -35mm) {
...
\begin{tikzpicture}[remember picture]
  ...
  \begin{scope}[shift={(NW)}]
      ...
      \Card{71}{-58}{Tin Nhắn (Người)}{57.2}{172.8}{$\downarrow$\,20.0\,\%}{cpos}
      \Card{17}{-94}{Task Hoàn Thành}{23.9}{61.6}{$\uparrow$\,1.9\,\%}{cneg}
      \Card{71}{-94}{Lỗi Phát Sinh}{16.2}{47.9}{$\uparrow$\,9.0\,\%}{cneg}
      \Card{17}{-130}{Tổng Commits}{54.5}{163.4}{$\downarrow$\,14.7\,\%}{cpos}
      ...
      \begin{axis}[at={(127mm,-106mm)},anchor=south west, width=194mm,height=80mm,hlchart]
        ...
        \addlegendentry{conflict/commit}
      \end{axis}
      \Insight{17}{-184}{bggr}{cgr}{\faSlack}{Sp1 (W1-2): Ổn định mức 0.88.}{Sp2 (W3-4): Giảm nhẹ 0.78.}{Sp3 (W5-7): Giảm sâu 0.62.}{Xu hướng giảm: Làm việc nhiều hơn.}
      \Insight{120}{-184}{bgbl}{cbl}{\faTrello}{Sp1 (W1-2): Lỗi cực thấp (0.30).}{Sp2 (W3-4): Đỉnh lỗi cao (5.22).}{Sp3 (W5-7): Giảm còn 1.33.}{Xu hướng tăng: Lỗi trên tính năng mới.}
      \Insight{223}{-184}{bgbk}{cbk}{\faGithub}{Sp1 (W1-2): An toàn (0.19).}{Sp2 (W3-4): Nhảy vọt lên 0.77.}{Sp3 (W5-7): Duy trì mức 0.49.}{Xu hướng tăng: Nợ kỹ thuật gia tăng.}
  \end{scope}
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture]
  ...
  \begin{scope}[shift={(NW)}]
    ...
    \node[anchor=north west, label={[sap]below:V2 - Menu}] at (118mm, -35mm) {
      \includegraphics[width=95mm, height=135mm, keepaspectratio]{09-gameConsoleGuide-screenshot-v2.png}
    };
    \node[anchor=north west, label={[sap]below:V2 - Stories}] at (219mm, -35mm) {
...
\begin{tikzpicture}[remember picture]
  ...
  \begin{scope}[shift={(NW)}]
    ...
    \node[anchor=north west, label={[sap]below:V2 - Loading}] at (118mm, -35mm) {
      \includegraphics[width=95mm, height=135mm, keepaspectratio]{08-gameStoryGuide-screenshot-v2.png}
    };
    \node[anchor=north west, label={[sap]below:V2 - Dialogue}] at (219mm, -35mm) {
...
\begin{tikzpicture}[remember picture]
  ...
  \begin{scope}[shift={(NW)}]
    ...
    % Thêm scope để canh giữa và phóng to vừa vặn với kích thước slide
    \begin{scope}[
        shift={(170mm, -105mm)}, 
        scale=1.1, 
        transform shape,
...
\begin{tikzpicture}[remember picture]
  ...
  \begin{scope}[shift={(NW)}]
    ...
    \matrix (techtable) [
      ...
      SQLite & 
      ~ & 
      { \Large\faDatabase \\[1ex] Offline Database } & 
      { \Large\faCloud \\[1ex] Online Database } \\
    ...
    % Highlighted underline for the first row (Yellow highlight)
    \draw[cyel, line width=4pt] ([yshift=-2mm]techtable-1-1.south west) -- ([yshift=-2mm]techtable-1-4.south east);

    % Subtle dashed dividers for the other rows
...
\begin{tikzpicture}[remember picture]
  ...
  \begin{scope}[shift={(NW)}]
    ...
    % Container for the 4-layer architecture
    \begin{scope}[
        shift={(17mm, -45mm)},
...
\begin{tikzpicture}[remember picture, overlay]
  \coordinate (NW) at (current page.north west);
  \begin{scope}[shift={(NW)}]
    \TitleLine{Bài học lập trình nhóm}
  \end{scope}
\end{tikzpicture}
\newpage
