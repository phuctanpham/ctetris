...
\newcommand{\TOCitem}[1]{{\color{cyel}\vrule width 2pt height 8pt depth 0pt}\ #1}
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \begin{scope}[shift={(NW)}]
    ...
    {
      \TOCitem{Slide 1: Phân hệ chính - Tổng quát} & \TOCitem{Slide 2: Phân hệ chính - V1 vs V2} & \TOCitem{Slide 3: Phân hệ chính - Thống kê} \\
      \TOCitem{Slide 4: Phân hệ cấu hình - Tổng quát} & \TOCitem{Slide 5: Phân hệ cấu hình - V1 vs V2} & \TOCitem{Slide 6: Phân hệ cấu hình - Thống kê} \\
      \TOCitem{Slide 7: Phân hệ tuyến truyện - Tổng quát} & \TOCitem{Slide 8: Phân hệ tuyến truyện - V1 vs V2} & \TOCitem{Slide 9: Phân hệ tuyến truyện - Thống kê} \\
      \TOCitem{Slide 10: Sơ đồ gameLoop} & \TOCitem{Slide 11: Chiến lược công nghệ} & \TOCitem{Slide 12: Sơ đồ lớp và CSDL} \\
      \TOCitem{Slide 13: Nguồn gốc xung đột} & \TOCitem{Slide 14: Giải quyết xung đột} & \TOCitem{Slide 15: Bài học làm việc nhóm} \\
    };
  \end{scope}
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \begin{scope}[shift={(NW)}]
      ...
      \begin{axis}[at={(127mm,-106mm)},anchor=south west, width=194mm,height=80mm,hlchart]
        ...
        \addlegendentry{conflict/commit}
      \end{axis}
      \Insight{17}{-184}{bggr}{cgr}{\faSlack}{Sp1 (W1-2): Nhóm khởi đầu đồng đều 0.88.}{Sp2 (W3-4): Tỷ lệ giảm 0.78 khi tăng tốc xây dựng.}{Sp3 (W5-7): Đạt mức tự chủ 0.62.}{Vòng lặp 60 FPS giảm phụ thuộc AI.}
      \Insight{120}{-184}{bgbl}{cbl}{\faTrello}{Sp1 (W1-2): Lỗi kiểm soát tốt ở 0.30.}{Sp2 (W3-4): Bùng phát 5.22 – xây dựng hệ vật lý.}{Sp3 (W5-7): Giảm còn 1.33 sau tối ưu.}{Lỗi tập trung ở thuật toán va chạm 20×10.}
      \Insight{223}{-184}{bgbk}{cbk}{\faGithub}{Sp1 (W1-2): Merge ổn định (0.19).}{Sp2 (W3-4): Nhảy vọt 0.77 – refactor cốt lõi.}{Sp3 (W5-7): Duy trì 0.49 sau chuẩn hóa.}{Tái cấu trúc game loop gây xung đột cao điểm.}
  \end{scope}
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \begin{scope}[shift={(NW)}]
      ...
      \begin{axis}[at={(127mm,-106mm)},anchor=south west, width=194mm,height=80mm,hlchart]
        ...
        \addlegendentry{conflict/commit}
      \end{axis}
      \Insight{17}{-184}{bggr}{cgr}{\faSlack}{Sp1 (W1-2): Tỷ lệ giao tiếp ổn định 0.88.}{Sp2 (W3-4): Giảm 0.78 khi tích hợp DB.}{Sp3 (W5-7): Cán mốc 0.62 – cấu hình vững.}{Ít hỏi AI hơn khi nắm vững SQLite.}
      \Insight{120}{-184}{bgbl}{cbl}{\faTrello}{Sp1 (W1-2): Lỗi thấp nhất cả dự án (0.27).}{Sp2 (W3-4): Vọt lên 2.91 – tích hợp Cloudflare D1.}{Sp3 (W5-7): Chưa về chuẩn, duy trì 1.83.}{D1 API là nguồn phát sinh lỗi chính.}
      \Insight{223}{-184}{bgbk}{cbk}{\faGithub}{Sp1 (W1-2): Xung đột rất thấp (0.19).}{Sp2 (W3-4): Tăng lên 0.61 khi merge schema DB.}{Sp3 (W5-7): Kiểm soát còn 0.49 sau chia nhánh.}{Module cấu hình chung gây xung đột chéo.}
  \end{scope}
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \begin{scope}[shift={(NW)}]
      ...
      \begin{axis}[at={(127mm,-106mm)},anchor=south west, width=194mm,height=80mm,hlchart]
        ...
        \addlegendentry{conflict/commit}
      \end{axis}
      \Insight{17}{-184}{bggr}{cgr}{\faSlack}{Sp1 (W1-2): Bắt đầu ở 0.88 – AI hỗ trợ SVG.}{Sp2 (W3-4): Duy trì 0.79 – cốt truyện phức tạp.}{Sp3 (W5-7): Đạt 0.62 sau khi API ổn định.}{Gist sync giảm yêu cầu hỏi AI trực tiếp.}
      \Insight{120}{-184}{bgbl}{cbl}{\faTrello}{Sp1 (W1-2): Tỷ lệ lỗi cao ngay từ đầu (0.42).}{Sp2 (W3-4): Đỉnh 3.37 – hệ thống hội thoại.}{Sp3 (W5-7): Giảm tốt về 1.33 sau refactor.}{Module đa phương tiện khó nhất, lỗi xuất hiện sớm.}
      \Insight{223}{-184}{bgbk}{cbk}{\faGithub}{Sp1 (W1-2): Git ratio cao hơn chuẩn (0.24).}{Sp2 (W3-4): Lên 0.61 khi tích hợp Gist API.}{Sp3 (W5-7): Ổn định 0.49 sau khi SHA sync vận hành.}{Đồng bộ mã băm phức tạp dễ gây xung đột merge.}
  \end{scope}
\end{tikzpicture}
\newpage
