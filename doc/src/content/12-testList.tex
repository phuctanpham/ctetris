...
\hline
\textbf{Mã tài liệu}     & STS-02 \\ \hline
\textbf{Phiên bản}       & 1.0 \\ \hline
\textbf{Năm học}         & 2024 – 2025 \\ \hline
\textbf{Môn học}         & SS004.F21 – Kiểm Thử Phần Mềm \\ \hline
\textbf{Dự án}           & cTetris – Console Tetris Game (C++) \\ \hline
\textbf{Tài liệu liên quan} & STS-01 – Test Strategy \\ \hline
\textbf{Tình trạng}      & Chính thức / Released \\ \hline
\end{tabularx}
\end{table}
...
% ────────────────────────────────────────────────────────────────────
% 8. KIỂM THỬ TỐC ĐỘ RƠI SAU removeLine()
% ────────────────────────────────────────────────────────────────────
